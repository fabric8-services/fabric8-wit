...
func TestIsXYError(t *testing.T) {
	...
	testCases := []struct {
		...
		{"IsInternalError - is an InternalError", errors.NewInternalError("some message"), errors.IsInternalError, true},
		{"IsInternalError - is a wrapped InternalError", errs.Wrap(errs.Wrap(errors.NewInternalError("some message"), "msg1"), "msg2"), errors.IsInternalError, true},
		...
		{"IsNotFoundError - is not a NotFoundError", errors.NewInternalError("some message"), errors.IsNotFoundError, false},
		...
		{"IsUnauthorizedError - is not an UnauthorizedError", errors.NewInternalError("some message"), errors.IsUnauthorizedError, false},
		...
		{"IsVersionConflictError - is not a VersionConflictError", errors.NewInternalError("some message"), errors.IsVersionConflictError, false},
	}
