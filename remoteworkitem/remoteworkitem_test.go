...
const (
	GithubIssueWithAssignee    = "http://api.github.com/repos/almighty/almighty-core/issues/132"
	GithubIssueWithoutAssignee = "https://api.github.com/repos/sbose78/mysql-transfer/issues/1"
...
func TestFlattenGithubResponseMap(t *testing.T) {
	...
	for k := range githubKeyMap {
		...
		if ok == false && string(k) != GithubAssignee {
