 ...
 * Start a OpenShift cluster and make sure you can access it from your `oc` command line.

 * Create OpenShift project to deploy application

----
$ oc login -u username -p password
$ oc new-project almightycore
----

NOTE: If above commands fail you have no access to cluster.


 * Using services file to deploy application to OpenShift directly:

----
$ cd $GOPATH/src/github.com/almighty/almighty-core/
$ kompose --opencompose services.yml --provider openshift up
----

 * If you want to tweak the OpenShift artifacts or just study them before you deploy the application to OpenShift then you do a 2 step process.

----
$ kompose --opencompose services.yml --provider openshift convert
----

 * At this step you can view or edit the OpenShift artifacts, and then deploy it to OpenShift.
