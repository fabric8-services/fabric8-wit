...
NOTE: You can see and interact with the whole API using Swagger UI. Go to link:http://generator.swagger.io/[generator.swagger.io] and add http://localhost:8080/api/swagger.json in the input box and press explore.
