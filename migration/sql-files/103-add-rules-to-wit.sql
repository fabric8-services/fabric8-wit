...
update work_items set fields = fields || '{"system.metastate": "mDeferred", "system.boardcolumns": [] }' WHERE fields @> '{"system.state": "Deferred"}' AND type='6ff83406-caa7-47a9-9200-4ca796be11bb';
-- Agile Template - Epic
...
update work_items set fields = fields || '{"system.metastate": "mDeferred", "system.boardcolumns": [] }' WHERE fields @> '{"system.state": "Deferred"}' AND type='2c169431-a55d-49eb-af74-cc19e895356f';
update work_items set fields = fields || '{"system.metastate": "mNoplantoimplement", "system.boardcolumns": [] }' WHERE fields @> '{"system.state": "No Plan to Implement"}' AND type='2c169431-a55d-49eb-af74-cc19e895356f';
...
update work_items set fields = fields || '{"system.metastate": "mDeferred", "system.boardcolumns": [] }' WHERE fields @> '{"system.state": "Deferred"}' AND type='5182fc8c-b1d6-4c3d-83ca-6a3c781fa18a';
update work_items set fields = fields || '{"system.metastate": "mNoplantoimplement", "system.boardcolumns": [] }' WHERE fields @> '{"system.state": "No Plan to Implement"}' AND type='5182fc8c-b1d6-4c3d-83ca-6a3c781fa18a';
