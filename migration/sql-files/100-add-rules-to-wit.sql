...
update work_items set fields = fields || '{"system.metastate": "mClosed", "system.boardcolumns": ["9f780106-4d71-41bf-b017-001ca7e19162", "ca1ea842-1650-4435-88b3-560e5bf47d42"] }' WHERE fields @> '{"system.state": "Closed"}' AND type="03b9bb64-4f65-4fa7-b165-494cd4f01401";
...
update work_items set fields = fields || '{"system.metastate": "mClosed", "system.boardcolumns": ["9f780106-4d71-41bf-b017-001ca7e19162, ca1ea842-1650-4435-88b3-560e5bf47d42"] }' WHERE fields @> '{"system.state": "Closed"}' AND type="fce0921f-ea70-4513-bb91-31d3aa8017f1";
-- Agile Template - Task
...
update work_items set fields = fields || '{"system.metastate": "mClosed", "system.boardcolumns": ["9f780106-4d71-41bf-b017-001ca7e19162, ca1ea842-1650-4435-88b3-560e5bf47d42"] }' WHERE fields @> '{"system.state": "Closed"}' AND type="2853459d-60ef-4fbe-aaf4-eccb9f554b34";
...
update work_items set fields = fields || '{"system.metastate": "mClosed", "system.boardcolumns": ["9f780106-4d71-41bf-b017-001ca7e19162, ca1ea842-1650-4435-88b3-560e5bf47d42"] }' WHERE fields @> '{"system.state": "Closed"}' AND type="6ff83406-caa7-47a9-9200-4ca796be11bb";
-- Agile Template - Epic
...
update work_items set fields = fields || '{"system.metastate": "mClosed", "system.boardcolumns": ["9f780106-4d71-41bf-b017-001ca7e19162, ca1ea842-1650-4435-88b3-560e5bf47d42"] }' WHERE fields @> '{"system.state": "Closed"}' AND type="2c169431-a55d-49eb-af74-cc19e895356f";
...
update work_items set fields = fields || '{"system.metastate": "mClosed", "system.boardcolumns": ["9f780106-4d71-41bf-b017-001ca7e19162, ca1ea842-1650-4435-88b3-560e5bf47d42"] }' WHERE fields @> '{"system.state": "Closed"}' AND type="5182fc8c-b1d6-4c3d-83ca-6a3c781fa18a";
