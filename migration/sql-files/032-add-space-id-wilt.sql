...
-- Add a default space_id to those tuples without one
ALTER TABLE work_item_link_types ALTER COLUMN space_id SET DEFAULT '2e0698d8-753e-4cef-bb7c-f027634824a2';
