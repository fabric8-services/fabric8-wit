...
update work_items set fields=jsonb_set(fields, '{system_description}', 
  jsonb_build_object('content', fields->>'system_description', 'markup', 'plain'))
  where fields->>'system_description' is not null;
