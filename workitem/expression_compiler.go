...
var DefaultTableJoins = func() TableJoinMap {
	res := TableJoinMap{
		"iteration": {
			...
			Where:            Column("iter", "space_id") + "=" + Column(WorkItemStorage{}.TableName(), "space_id"),
		...
		"area": {
			...
			Where:            Column("ar", "space_id") + "=" + Column(WorkItemStorage{}.TableName(), "space_id"),
		...
		"codebase": {
			...
			Where:            Column("cb", "space_id") + "=" + Column(WorkItemStorage{}.TableName(), "space_id"),
