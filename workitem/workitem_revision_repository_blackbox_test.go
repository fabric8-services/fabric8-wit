...
func (s *workItemRevisionRepositoryBlackBoxTest) TestStoreWorkItemRevisions() {
	...
	assert.Equal(s.T(), workItem.Type, workitemRevision1.WorkItemTypeID)
	...
	assert.Equal(s.T(), workItem.Type, workitemRevision2.WorkItemTypeID)
	...
	assert.Equal(s.T(), workItem.Type, workitemRevision3.WorkItemTypeID)
	...
	assert.Equal(s.T(), workItem.Type, workitemRevision4.WorkItemTypeID)
