...
func TestConstants(t *testing.T) {
	...
	require.Equal(t, "system_description.markup", workitem.SystemDescriptionMarkup)
	require.Equal(t, "system_description.rendered", workitem.SystemDescriptionRendered)
