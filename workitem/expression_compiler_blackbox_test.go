...
func TestField(t *testing.T) {
	...
	// test joined tables
	expect(t, Not(Field("iteration.name"), Literal("abcd")), "(iter.name != ?)", []interface{}{"abcd"})
}
...
func expect(t *testing.T, expr Expression, expectedClause string, expectedParameters []interface{}, expectedJoins map[string]workitem.TableJoin) {
