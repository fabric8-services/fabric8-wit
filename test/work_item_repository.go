...
type WorkItemRepository struct {
	...
	LoadStub        func(ctx context.Context, spaceID uuid.UUID, wiNumber int) (*workitem.WorkItem, error)
	...
	ReorderStub        func(ctx context.Context, spaceID uuid.UUID, direction workitem.DirectionType, targetID *uuid.UUID, wi workitem.WorkItem, modifierID uuid.UUID) (*workitem.WorkItem, error)
	...
	DeleteStub        func(ctx context.Context, id uuid.UUID, suppressorID uuid.UUID) error
	...
	ListStub        func(ctx context.Context, spaceID uuid.UUID, criteria criteria.Expression, parentExists *bool, start *int, length *int) ([]workitem.WorkItem, int, error)
...
func (fake *WorkItemRepository) LoadByID(ctx context.Context, id uuid.UUID) (*workitem.WorkItem, error) {
	...
	fake.recordInvocation("LoadByID", []interface{}{ctx, id})
...
func (fake *WorkItemRepository) LoadByIDCallCount() int {
	fake.loadByIDMutex.RLock()
	defer fake.loadByIDMutex.RUnlock()
	return len(fake.loadByIDArgsForCall)
}

func (fake *WorkItemRepository) LoadByIDArgsForCall(i int) (context.Context, uuid.UUID) {
	fake.loadByIDMutex.RLock()
	defer fake.loadByIDMutex.RUnlock()
	return fake.loadByIDArgsForCall[i].ctx, fake.loadByIDArgsForCall[i].id
}
...
func (fake *WorkItemRepository) Load(ctx context.Context, spaceID uuid.UUID, wiNumber int) (*workitem.WorkItem, error) {
	fake.loadMutex.Lock()
	fake.loadArgsForCall = append(fake.loadArgsForCall, struct {
		ctx      context.Context
		spaceID  uuid.UUID
		wiNumber int
	}{ctx, spaceID, wiNumber})
	fake.recordInvocation("Load", []interface{}{ctx, spaceID, wiNumber})
	fake.loadMutex.Unlock()
	if fake.LoadStub != nil {
		return fake.LoadStub(ctx, spaceID, wiNumber)
	}
...
func (fake *WorkItemRepository) LoadArgsForCall(i int) (context.Context, uuid.UUID, int) {
	fake.loadMutex.RLock()
	defer fake.loadMutex.RUnlock()
	return fake.loadArgsForCall[i].ctx, fake.loadArgsForCall[i].spaceID, fake.loadArgsForCall[i].wiNumber
}
...
func (fake *WorkItemRepository) Reorder(ctx context.Context, spaceID uuid.UUID, direction workitem.DirectionType, targetID *uuid.UUID, wi workitem.WorkItem, modifierID uuid.UUID) (*workitem.WorkItem, error) {
	...
	fake.reorderArgsForCall = append(fake.reorderArgsForCall, struct {
		...
		wi         workitem.WorkItem
		modifierID uuid.UUID
	}{ctx, spaceID, direction, targetID, wi, modifierID})
	fake.recordInvocation("Reorder", []interface{}{ctx, spaceID, direction, targetID, wi, modifierID})
	fake.reorderMutex.Unlock()
	if fake.ReorderStub != nil {
		return fake.ReorderStub(ctx, spaceID, direction, targetID, wi, modifierID)
	}
...
func (fake *WorkItemRepository) ReorderArgsForCall(i int) (context.Context, uuid.UUID, workitem.DirectionType, *uuid.UUID, workitem.WorkItem, uuid.UUID) {
	fake.reorderMutex.RLock()
	defer fake.reorderMutex.RUnlock()
	return fake.reorderArgsForCall[i].ctx, fake.reorderArgsForCall[i].spaceID, fake.reorderArgsForCall[i].direction, fake.reorderArgsForCall[i].targetID, fake.reorderArgsForCall[i].wi, fake.reorderArgsForCall[i].modifierID
}

func (fake *WorkItemRepository) ReorderReturns(result1 *workitem.WorkItem, result2 error) {
...
func (fake *WorkItemRepository) Delete(ctx context.Context, id uuid.UUID, suppressorID uuid.UUID) error {
...
func (fake *WorkItemRepository) DeleteArgsForCall(i int) (context.Context, uuid.UUID, uuid.UUID) {
	fake.deleteMutex.RLock()
	defer fake.deleteMutex.RUnlock()
...
func (fake *WorkItemRepository) List(ctx context.Context, spaceID uuid.UUID, c criteria.Expression, parentExists *bool, start *int, length *int) ([]workitem.WorkItem, int, error) {
	fake.listMutex.Lock()
	fake.listArgsForCall = append(fake.listArgsForCall, struct {
		...
		start        *int
		length       *int
	}{ctx, spaceID, c, parentExists, start, length})
	fake.recordInvocation("List", []interface{}{ctx, spaceID, c, parentExists, start, length})
	fake.listMutex.Unlock()
	if fake.ListStub != nil {
		return fake.ListStub(ctx, spaceID, c, parentExists, start, length)
	}
...
func (fake *WorkItemRepository) ListArgsForCall(i int) (context.Context, uuid.UUID, criteria.Expression, *bool, *int, *int) {
	fake.listMutex.RLock()
	defer fake.listMutex.RUnlock()
	return fake.listArgsForCall[i].ctx, fake.listArgsForCall[i].spaceID, fake.listArgsForCall[i].criteria, fake.listArgsForCall[i].parentExists, fake.listArgsForCall[i].start, fake.listArgsForCall[i].length
}

func (fake *WorkItemRepository) ListReturns(result1 []workitem.WorkItem, result2 int, result3 error) {
	fake.ListStub = nil
...
func (fake *WorkItemRepository) CountCallCount() int {
	fake.countMutex.RLock()
	defer fake.countMutex.RUnlock()
	return len(fake.countArgsForCall)
}

func (fake *WorkItemRepository) CountArgsForCall(i int) (context.Context, uuid.UUID, criteria.Expression) {
	fake.countMutex.RLock()
	defer fake.countMutex.RUnlock()
	return fake.countArgsForCall[i].ctx, fake.countArgsForCall[i].spaceID, fake.countArgsForCall[i].criteria
}

func (fake *WorkItemRepository) CountReturns(result1 int, result2 error) {
	fake.CountStub = nil
