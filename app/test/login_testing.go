...
func AuthorizeLoginOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.LoginController) (http.ResponseWriter, *app.AuthToken) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func AuthorizeLoginUnauthorized(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.LoginController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GenerateLoginOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.LoginController) (http.ResponseWriter, app.AuthTokenCollection) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	rw := httptest.NewRecorder()
	u := &url.URL{
		Path: fmt.Sprintf("/api/login/generate"),
	}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		panic("invalid test " + err.Error()) // bug
...
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func GenerateLoginUnauthorized(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.LoginController) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
