...
func ShowVersionOK(t *testing.T, ctx context.Context, service *goa.Service, ctrl app.VersionController) (http.ResponseWriter, *app.Version) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
