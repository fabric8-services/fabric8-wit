...
func (s *workItemLinkTypeSuite) TestUpdateWorkItemLinkTypeConflict() {
	...
	// when/then
	test.UpdateWorkItemLinkTypeConflict(s.T(), s.svc.Context, s.svc, s.linkTypeCtrl, updateLinkTypePayload.Data.Relationships.Space.Data.ID.String(), *updateLinkTypePayload.Data.ID, updateLinkTypePayload)
}
