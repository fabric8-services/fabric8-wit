...
func (s *workItemChildSuite) SetupTest() {
	...
	createPayload := newCreateWorkItemLinkPayload(s.bug1ID, bug2ID, bugBlockerLinkTypeID)
	...
	createPayload2 := newCreateWorkItemLinkPayload(s.bug1ID, bug3ID, bugBlockerLinkTypeID)
