= Getting started with almighty-core development on Windows
...
1. If your download doesn't start automatically click he **64-bit Git for Windows Setup.** link.
...
1. Hit the kbd:[Windows] key on your keyboard and type `cygwin` to start searching for the *Cygwin64 Termina*. Hit kbd:[Enter].
