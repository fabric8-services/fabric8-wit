...
type SearchRepository interface {
	...
	Filter(ctx context.Context, filterStr string, parentExists *bool, start *int, length *int) ([]workitem.WorkItem, uint64, link.AncestorList, link.WorkItemLinkList, error)
}
